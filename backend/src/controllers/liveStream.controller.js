...
export const createLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(
        new ApiResponse(201, liveStream, 'Live stream created successfully')
    );
});
...
export const startLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, liveStream, 'Live stream started successfully')
    );
});
...
export const endLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, liveStream, 'Live stream ended successfully')
    );
});
...
export const getLiveStreamDetails = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, liveStream, 'Live stream details fetched successfully')
    );
});
...
export const getActiveLiveStreams = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, liveStreams, 'Active live streams fetched successfully')
    );
});
...
export const joinLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, { liveStream, viewer }, 'Joined live stream successfully')
    );
});
...
export const leaveLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, null, 'Left live stream successfully')
    );
});
...
export const sendLiveComment = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(
        new ApiResponse(201, comment, 'Comment sent successfully')
    );
});
...
export const deleteLiveStream = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, null, 'Live stream deleted successfully')
    );
});
