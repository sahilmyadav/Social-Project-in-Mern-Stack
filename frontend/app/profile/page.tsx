            ...
            <div>
              ...
              <div className="flex border-b border-border mb-6">
                <button
                  ...
                  className={`cursor-pointer flex-1 py-3 font-semibold transition ${activeTab === "posts"
                ...
                <button
                  ...
                  className={`cursor-pointer flex-1 py-3 font-semibold transition ${activeTab === "reels"
                    ? "text-primary border-b-2 border-primary"
                    : "text-muted-foreground hover:text-foreground"
                    }`}
                >
                ...
                <button
                  ...
                  className={` cursor-pointer flex-1 py-3 font-semibold transition ${activeTab === "saved"
                    ? "text-primary border-b-2 border-primary"
                    : "text-muted-foreground hover:text-foreground"
                    }`}
                >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="p-4">
                              ...
                              <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                                <span className="flex items-center gap-1"><Heart size={14} className="text-red-500 fill-red-500" /> {post.likes_count || 0}</span>
