  ...
  const handleTogglePrivateAccount = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        alert(newPrivacyStatus ? "Your account is now private" : "Your account is now public")
      } else {
            ...
            <div className="flex gap-4 mb-8 border-b border-border">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-3 font-semibold flex items-center gap-2 border-b-2 transition ${activeTab === tab.id
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      ...
                      <button
                        ...
                        disabled={!mounted}
                        className={`w-12 h-7 rounded-full transition ${mounted && theme === "dark" ? "bg-primary" : "bg-muted-foreground"
                          } disabled:opacity-50`}
                      >
                        <div
                ...
                <div className="bg-card rounded-lg border border-border p-6">
                  ...
                  <div className="space-y-4">
                    {([
                      ...
                      { key: "promotions", label: "Promotions and offers", icon: "🎁" },
                    ] as const).map((notif) => (
                      <div key={notif.key} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                        ...
                        <button
                          ...
                          className={`w-12 h-7 rounded-full transition ${notifications[notif.key as keyof typeof notifications]
                            ? "bg-primary"
                            : "bg-muted-foreground"
                            }`}
                        >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      ...
                      <button
                        ...
                        className={`w-12 h-7 rounded-full transition ${isPrivateAccount ? "bg-primary" : "bg-muted-foreground"
                          } disabled:opacity-50`}
                      >
                        <div
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                      ...
                      <button className="w-12 h-7 rounded-full bg-primary">
