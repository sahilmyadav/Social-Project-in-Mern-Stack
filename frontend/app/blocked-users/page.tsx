                ...
                <section className="lg:col-span-3 p-4 lg:p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground mt-2">
                            Manage users you've blocked. Blocked users can't see your profile, posts, or message you.
                        </p>
                    </div>
                        ...
                        {loading ? (
                            ...
                            <div className="divide-y divide-border">
                                {blockedUsers.map((blockedUser) => {
                                    ...
                                    const fullName = blockedUser.fullName || `${blockedUser.firstName || ''} ${blockedUser.lastName || ''}`.trim()
                                    const username = blockedUser.username || blockedUser.email || 'user'
                                    const avatar = blockedUser.profilePicture || blockedUser.profileImage || blockedUser.avatar
