    ...
    try {
      ...
      setComments(prev => prev.map(comment =>
        comment._id === commentId
          ? { ...comment, isLiked: !comment.isLiked, likes_count: comment.isLiked ? (comment.likes_count || 1) - 1 : (comment.likes_count || 0) + 1 }
          : comment
      ))
    } catch (error) {
      ...
      <div className="p-4 border-t border-border">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition font-semibold flex-1 justify-center ${liked ? "text-accent bg-accent/10" : "text-muted-foreground hover:bg-muted"
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-muted transition font-semibold text-muted-foreground flex-1 justify-center"
          >
