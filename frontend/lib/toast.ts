...
export const toasts = {
    ...
    // Block actions
    userBlocked: (username: string) => showToast.success("User blocked", `${username} has been blocked. They won't be able to find your profile or contact you.`),
    userUnblocked: (username: string) => showToast.success("User unblocked", `${username} has been unblocked. You can now interact with them again.`),
